package com.teeconoa.common.utils.file;
...
import com.teeconoa.common.exception.file.FileNameLengthLimitExceededException;
import com.teeconoa.framework.config.TeeconOAConfig;

/**
 * 文件上传工具类
*  Created by AndyYau
*  2019年2月15日 - 上午9:49:35
*  Company: Teecon
**/
public class FileUploadUtils {
	...
	//默认上传地址
	private static String defaultBaseDir = TeeconOAConfig.getProfile();
