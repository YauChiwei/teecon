...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO {
    ...
    public void syncToDb(OnlineSession onlineSession) {
    	...
    	if(lastSyncTimestamp != null) {
    		...
    		long dateTime = onlineSession.getLastAccessTime().getTime() - lastSyncTimestamp.getTime();
    	...
    	AsyncManager.newInstance().executeTask(AsyncFactory.syncSessionToDatabase(onlineSession));
    }
}
