package com.teeconoa.framework.shiro.web.filter;
		...
		try {
			...
			try {
				...
				if(StringUtils.isNotNull(user)) {
					...
					AsyncManager.newInstance().executeTask(AsyncFactory.recordLogininfor(loginName, Constants.LOGOUT, MessageUtils.message("user.logout.success")));
				}
				subject.logout();
